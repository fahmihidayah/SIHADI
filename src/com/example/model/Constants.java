...
public interface Constants {
	...
	public static final String SENDER_ID ="553661011522";
	
	public static final String CHAT_DATA_FILE = "CHAT_DATA.txt";
	public static final String CURRENT_ACTIVITY_FILE = "CURRENT_ACTIVITY.txt";
